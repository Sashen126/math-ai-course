# Capstone Skill Notes

## Refined Skill Source
`.agent/skills/lecture-generator.skill.md`
...
## What Was Refined from Week 5
1. Added explicit coherence checks across slides, video, and animation.
2. Elevated lecture arc planning to the first required step.
3. Added completeness constraint for full-length narration coverage.
4. Added reflection as a required output to support iteration quality.
5. Tightened output contract to capstone paths for direct grading alignment.
